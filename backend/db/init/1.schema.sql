...
(
    ...
    CONSTRAINT FK_Order_User FOREIGN KEY ( User_ID ) REFERENCES shop.user ( User_ID )
);
...
(
    ...
    CONSTRAINT FK_OrderTable_Order FOREIGN KEY ( Order_ID ) REFERENCES shop.order ( Order_ID ),
    CONSTRAINT FK_OrderTable_Product FOREIGN KEY ( Product_ID ) REFERENCES shop.product ( Product_ID )
);
...
(
    ...
    CONSTRAINT FK_Location_Product FOREIGN KEY ( Product_ID ) REFERENCES shop.product ( Product_ID ),
    CONSTRAINT FK_Location_Shelve FOREIGN KEY ( Shelve_ID ) REFERENCES shop.shelve ( Shelve_ID )
);
...
-- https://dbdiagram.io/d/661a27ea03593b6b61e44887
-- cat ./query.sql | docker exec -i shop_db psql -U root -d shop_db